...
- Current status: UI scaffold completed; Binary Search, BFS, DFS, Dijkstra, A*, Bubble Sort, Selection Sort, Insertion Sort, and Merge Sort shipped as engine-backed vertical slices, with remaining engines pending.
