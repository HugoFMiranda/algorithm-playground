...
Current implementation is full for Binary Search, BFS, DFS, Dijkstra, A*, Bubble Sort, Selection Sort, Insertion Sort, and Merge Sort. Remaining algorithms keep scaffolded UI placeholders until their engines are integrated.
